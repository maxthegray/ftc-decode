...
public class RedAuto2 extends OpMode {
    ...
    // New Set
    private final Pose startPose = new Pose(122, 122.8, Math.toRadians(125)); //starting pose
    private final Pose pose2 = new Pose(103, 102.7, Math.toRadians(60)); //first shoot
    private final Pose pose3 = new Pose(120, 84, Math.toRadians(0)); //middle balls
    private final Pose pose4 = new Pose(103, 102, Math.toRadians(45)); //second shoot
    private final Pose pose5 = new Pose(120, 35, Math.toRadians(0)); //far balls
    private final Pose pose6 = new Pose(84.5, 11, Math.toRadians(45)); //third shoot
    private final Pose pose21 = new Pose (82.3,78.9); //control 1
    private final Pose pose31 = new Pose(67.2,22); //control 2
