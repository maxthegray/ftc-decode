...
//            telemetry.addData("A: Threshold", CarouselSubsystem.THRESHOLD_INTAKE_A);
//
//            telemetry.addData("B: alpha", intakeB.alpha());
//            telemetry.addData("B: blue/green", String.format("%.2f", ratio(intakeB)));
//            telemetry.addData("B: Threshold", CarouselSubsystem.THRESHOLD_INTAKE_B);
//
//            // Back Left position
...
//            telemetry.addData("A: Threshold", CarouselSubsystem.THRESHOLD_BACK_LEFT_A);
//
//            telemetry.addData("B: alpha", backLeftB.alpha());
//            telemetry.addData("B: blue/green", String.format("%.2f", ratio(backLeftB)));
//            telemetry.addData("B: Threshold", CarouselSubsystem.THRESHOLD_BACK_LEFT_B);
//
//            // Back Right position
...
//            telemetry.addData("A: Threshold", CarouselSubsystem.THRESHOLD_BACK_RIGHT_A);
//
//            telemetry.addData("B: alpha", backRightB.alpha());
//            telemetry.addData("B: blue/green", String.format("%.2f", ratio(backRightB)));
//            telemetry.addData("B: Threshold", CarouselSubsystem.THRESHOLD_BACK_RIGHT_B);
//
//
//            telemetry.update();
//        }
