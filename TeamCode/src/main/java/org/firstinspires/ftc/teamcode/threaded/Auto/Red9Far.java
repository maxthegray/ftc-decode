...
public class Red9Far extends OpMode {
    ...
    private final Pose startPose = new Pose(42.195, 134.813, Math.toRadians(-90));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            initialShoot = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(42.195, 134.813),
                                    new Pose(55.053, 124.525)
                            )
            ...
            GoToBall1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(55.053, 124.525),
                                    new Pose(45.289, 117.096),
                                    new Pose(43.641, 108.936)
                            )
            ...
            shoot2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(16.291, 108.609),
                                    new Pose(39.975, 109.638),
                                    new Pose(56.177, 126.585)
                            )
            ...
            shoot3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(10.861, 137.072),
                                    new Pose(27.744, 111.638),
