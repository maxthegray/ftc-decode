...
public class Red9Close extends OpMode {
    ...
    private final Pose startPose = new Pose(27.964, 15.554, Math.toRadians(0));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ReadTagAndGoToShoot = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(27.964, 15.554),
                                    new Pose(32.436, 41.269),
                                    new Pose(53.000, 55.000)
                            )
            ...
            GoToBall1Position = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(54.000, 55.000),
                                    new Pose(59.689, 77.159),
                                    new Pose(48.175, 83.817)
                            )
            ...
            Shoot2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(9.888, 84.191),
                                    new Pose(45.000, 100.000),
                                    new Pose(54.000, 61.000)
                            )
